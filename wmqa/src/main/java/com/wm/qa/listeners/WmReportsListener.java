...
import com.wm.qa.exceptions.WmReporterStepFailedException;
import com.wm.qa.utils.Attributes;
import com.wm.qa.utils.Directory;
import com.wm.qa.utils.Platform;
import com.wm.qa.utils.SettingsFile;
import com.wm.qa.utils.TestParameters;
import com.wm.qa.writers.ConsolidatedReportsPageWriter;
import com.wm.qa.writers.CurrentRunPageWriter;
import com.wm.qa.writers.HTMLDesignFilesJSWriter;
import com.wm.qa.writers.IndexPageWriter;
import com.wm.qa.writers.TestCaseReportsPageWriter;
import com.wm.qa.WmReports;

public class WmReportsListener implements ITestListener, IExecutionListener, IReporter, ISuiteListener {

	static Logger log = Logger.getLogger(WmReportsListener.class.getName());
	int runCount = 0;
	...
	public void onTestSuccess(ITestResult result)  {
		try
		{
			...
			{
				result.setStatus(2);
				result.setThrowable(new WmReporterStepFailedException());
	...
	public static void setPlatfromBrowserDetails(ITestResult paramITestResult)  {
		Platform.prepareDetails(WmReports.getWebDriver());
	...
	public void generateIndexPage()  {
		...
		try
		{
			...
			IndexPageWriter.content(localPrintWriter, WmReports.indexPageDescription);
