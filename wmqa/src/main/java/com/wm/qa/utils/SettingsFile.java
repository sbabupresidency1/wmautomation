...
public class SettingsFile {
	...
	public static void initSettingsFile() throws WmReporterException  {
	...
	public static void create(String paramString) throws WmReporterException  {
		...
		{
			throw new WmReporterException("Unable To Create Required Files for Custom Reports");
		}
	}

	public static void open() throws WmReporterException  {
		...
		{
			throw new WmReporterException("Settings File Not Available");
		}
		catch (IOException localIOException)
		{
			throw new WmReporterException("Unable To Create Required Files for Custom Reports");
	...
	public static void close() throws WmReporterException  {
		try
		{
	...
	public static void correctErrors() throws NumberFormatException, WmReporterException  {
	...
	public static int getHighestTestCaseNumber() throws WmReporterException  {
	...
	public static String get(String propertyKey) throws WmReporterException  {
		open();
	...
	public static void set(String key, String value) throws WmReporterException  {
		open();
